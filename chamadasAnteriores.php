...
$query = "SELECT alunos.nome, faltas.id AS falta_id FROM alunos LEFT JOIN faltas ON alunos.nome = faltas.aluno_id AND faltas.data = '$data' AND faltas.bimestre = '$bimestre' AND faltas.disciplina = '$disciplina' WHERE alunos.turma_id = '$turma' AND alunos.escola = '$escola' ORDER BY alunos.nome";
...
<head>
    ...
    <title>Corrigir Chamada</title>
</head>
<body>

<div class="text-center  mb-3">
<h1 class="text-center mt-5 mb-0">Corrigir Chamada</h1>
...
<table class="table table-striped mt-5">
    ...
    <tbody>
        <?php
        echo '<form method="post" action="atualizar_faltas.php">';
        $i = 1;
        $prev_aluno_nome = "";
