...
if($status == "AV"){
    $query_delete = "DELETE FROM whitelist WHERE turma_id = '$turma' AND aluno_id = '$aluno_nome' AND bimestre = '$bimestre' AND insertBy = '$user_id' AND disciplina = '$disciplinaAtual'";
...
if($status != "AV"){
    ...
    $query_insert = "INSERT INTO `whitelist`(`aluno_id`, `insertBy`, `disciplina`, `bimestre`, `turma_id`, `status`) VALUES ('$aluno_nome','$insertBy','$disciplinaAtual','$bimestre','$turma','$status')";
